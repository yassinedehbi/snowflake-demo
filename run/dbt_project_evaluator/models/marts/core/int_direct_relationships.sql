  ...
  create or replace   view DEV_DB.DBT_VAULT.int_direct_relationships
...
direct_model_relationships as (
    ...
    from DEV_DB.DBT_VAULT.stg_node_relationships
),
...
direct_exposure_relationships as (
    select  
        ...
        direct_parent_id,
        is_primary_relationship
    from DEV_DB.DBT_VAULT.stg_exposure_relationships
),
...
direct_metrics_relationships as (
    select  
        ...
        direct_parent_id,
        is_primary_relationship
    from DEV_DB.DBT_VAULT.stg_metric_relationships
),
